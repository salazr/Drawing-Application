...
(function() {
  var DrawingApp, PF, readline, termCanvas;
  ...
  DrawingApp = (function() {
    var App, _drawPath, _fillPath, _handleErrors, _renderCanvas;
    ...
    _handleErrors = function(command) {
      switch (command[0]) {
        case 'C':
          if (command.length < 3) {
    ...
    _drawPath = function(x1, y1, x2, y2) {
    ...
    _fillPath = function(x, y, c) {
      ...
      if (y < height - 1) {
        return _fillPath(x, y + 1, c);
      }
    };

    DrawingApp.prototype._parseInput = function() {
      return App.rl.on('line', function(l) {
